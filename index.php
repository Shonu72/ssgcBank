...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <a href="index.php" class="logo"><img src="assets/img/logo.png" style=" height: 400px;"   class="img-fluid"> &nbsp SSGC BANK</a>
  ...
  <main id="main">
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <p>
                  ...
                  SSGC Bank is the best bank for Monitoring account it provide data in graphical manner from that can we understand our account is in profit or loss. Also i use saving option which is wonderful.
                  <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                </p>
                <img src="assets/img/testimonials/ayush.jpg" class="testimonial-img" alt="">
                <h3>Ayush Kumar</h3>
                <h4>Customer & Entrepreneur</h4>
              </div>
            </div><!-- End testimonial 1 item -->

            <div class="swiper-slide">
              <div class="testimonial-item">
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                  The Transaction system of the SSGC bank is very fast. We can easily manage our transaction history
                  with digramatical manner
                  <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                </p>
                <img src="assets/img/testimonials/akash.jpg" class="testimonial-img" alt="">
                <h3>Akash Rajhansh</h3>
                <h4>Customer & Future IAF officer</h4>
              </div>
            </div><!-- End testimonial 2 item -->
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <p>
                  ...
                  and start your online banking. Thank You SSGC Bank!
                  <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                </p>
                <img src="assets/img/testimonials/subham.jpg" class="testimonial-img" alt="">
                <h3>Subham Badhani</h3>
                <h4>Customer</h4>
              </div>
            </div><!-- End testimonial 3 item -->
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <img src="assets/img/testimonials/atul.jpg" class="testimonial-img" alt="">
                <h3>Atul Raj</h3>
                <h4>Customer</h4>
              </div>
            </div><!-- End testimonial 4 item -->
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <img src="assets/img/testimonials/surya.jpg" class="testimonial-img" alt="">
                <h3>Suryakant Mahto</h3>
                <h4>Entrepreneur</h4>
              </div>
            </div>
    ...
    <section id="contact" class="contact section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
        <div class="col-lg-6 " style="width: 50%"><iframe width="100%" height="400" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=Surya%20colony%20Ranchi+(SSGC%20Bank)&amp;t=&amp;z=13&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"><a href=""></a></iframe></div>

         

          <div class="col-lg-6">
            <form action="../ssgcBank/contact.php" method="POST">
              <div class="row">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              Surya colony <br>
              Upper chutia, Ranchi 834001<br>
              India <br><br>
              <strong>Phone:</strong> +91 8102015731<br>
              <strong>Email:</strong> sblogger810@gmail.com<br>
            </p>
          </div>
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="../ssgcBank/#services">Services</a></li>
          ...
          <div class="col-lg-4 col-md-6 footer-newsletter">
            ...
            <img src="assets/img/logo.png" style="width: 250px; height: 250px; " alt="">
            </div>
    ...
    <div class="container">
      ...
      <div class="copyright-wrap d-md-flex py-4">
        <div class="me-md-auto text-center text-md-start">
          <div class="copyright">
            &copy; Copyright <strong><span>SSGC Bank</span></strong>. All Rights Reserved
          </div>
