            ...
            <div class="simplebar-content" style="padding: 0px;">
                ...
                <ul class="navbar-nav align-self-stretch">
                    ...
                    <li class="menuHover">
                        ...
                        <a href="../Dashboard.php" class="nav-link text-left" role="button" aria-haspopup="true"
                            aria-expanded="false">
                                        ...
                                        <div class="col-lg-12 px-2">
                                            <div class="submenu-box">
                                                <ul class="list-unstyled m-0">
                                                    ...
                                                    <li><a class="active" href="../wallet/Deposit.php">Deposit Money</a>
                                                    </li>
                                        ...
                                        <div class="col-lg-12 px-2">
                                            <div class="submenu-box">
                                                <ul class="list-unstyled m-0">
                                                    ...
                                                    <li><a href="../accounts/ActivateAccount.php">Activate Account</a>
                                                    </li>
                                                    <li><a href="../accounts/DeactivateAccount.php">Deactivate
                                                            Account</a></li>
                                                ...
                                                <div style="margin-left: 15%; margin-right: 15%;">
                                                    <div class="input-group mt-5">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text gray_bg light"
                                                                id="inputGroup-sizing-default"><i
                                                                    class='bx bx-right-arrow-alt'
                                                                    style='color:#01be32'></i></span>
                                                        </div>
                                                        <input type="text" id="AccountNo"
                                                            class="form-control gray_bg light" aria-label="Default"
                                                            placeholder="Enter Customer Account No..."
                                                            aria-describedby="inputGroup-sizing-default">
                                                        <span id="info" hidden
                                                            class="input-group-append bg-transparent border-left-0">
                                                            <span class="input-group-text bg-transparent">
                                                                <i class='bx bx-info-circle'
                                                                    style="color: #01be32;"></i>
                                                            </span>
                                                        </span>
                                                    </div>
                                                    ...
                                                    <div class="input-group mb-1 mt-5">
                                                        ...
                                                        <input id="Amount" type="tel" class="form-control gray_bg light"
                                                            aria-label="Default" placeholder="Enter Amount..."
                                                            aria-describedby="inputGroup-sizing-default">
