...
<head>
    ...
    <title>Verify Account SSGC Bank</title>
            ...
            <div class="simplebar-content" style="padding: 0px;">
                ...
                <ul class="navbar-nav align-self-stretch">
                    ...
                    <li class="menuHover">
                        ...
                        <a href="../admin/Dashboard.php" class="nav-link text-left" role="button" aria-haspopup="true"
                            aria-expanded="false">
                                        ...
                                        <div class="card gray_bg">
                                            <div class="card-body ">
                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    <table id="EditTable" class="table v-middle"
                                                        ...
                                                        <tbody class="dark_bg">
                                                            ...
                                                            <?php
                                                                ...
                                                                ?>
                                                            <tr>
                                                                <th class="light" scope="row"><?php echo $row['ID']; ?>
                                                                </th>
                                                                ...
                                                                <td class="light">
                                                                    ...
                                                                    <button name="view_btn"
                                                                        id="<?php echo $row['AccountNo']; ?>"
                                                                        class="btn btn-custo view_data btn btn-primary"
                                                                        data-toggle="modal"
                                                                        data-target="#exampleModalLong"><i
                                                                            class='bx bx-show-alt'></i> View</button>

                                                                </td>
                                                                <td class="light">

                                                                    <button id="<?php echo $row['AccountNo']; ?>"
                                                                        class="btn btn-success verify_data"><i
                                                                ...
                                                                <td class="light">
                                                                    <button id="<?php echo $row['AccountNo'];
                                                                                        ?>"
                                                                        class="btn btn-danger reject_data"><i
                                                                            class='bx bx-user-x'></i> Reject</button>
                                                                    </form>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <?php
                                                                ...
                                                                ?>
                                                            <h1 class="light" style="text-align: center;">No Account for
                                                                Verification</h1>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content gray_bg">
                ...
                <div class="modal-body light">
                    <h6
                        style="margin-bottom: 30px; text-align:center; margin-top:20px;border-bottom: 1px solid;display: table;">
                        Basic Customer Detail: </h6>
                    ...
                    <!-- KYC Document -->
                    <h6 style="margin-bottom: 30px;margin-top: 30px;border-bottom: 1px solid;display: table;">KYC
                        Documents Uploaded: </h6>
