...
<head>
    ...
    <title>Dashboard SSGC Bank</title>
    ...
    <link type="text/css" rel="stylesheet" href="../admin/css/AdminDash.css">
...
<body class="dark_bg">
        ...
        <nav class="fixed-top align-top" id="sidebar-wrapper" role="navigation">
            <div class="simplebar-content" style="padding: 0px;">
                <a class="sidebar-brand" href="../index.php">
                    <span class="align-middle">SSGC BANK</span>
                </a>
                ...
                <ul class="navbar-nav align-self-stretch">
                    ...
                    <li class="has-sub menuHover">
                        <a class="nav-link collapsed text-left" href="#collapseExample2" role="button"
                            data-toggle="collapse">
                            <i class="flaticon-user"></i> <i class="bx bx-user-circle Profile ico"></i> Customer
                            Accounts
                        </a>
                                        ...
                                        <div class="col-lg-12 px-2">
                                            <div class="submenu-box">
                                                <ul class="list-unstyled m-0">
                                                    ...
                                                    <li><a href="../admin/accounts/EditAccount.php">Edit Account</a>
                                                    </li>
                                                    <li><a href="../admin/accounts/ActivateAccount.php">Activate
                                                            Account</a></li>
                                                    <li><a href="../admin/accounts/DeactivateAccount.php">Deactivate
                                                            Account</a></li>
                                                    <li><a href="../admin/accounts/CloseAccount.php">Close Account</a>
                                                    </li>
                    ...
                    <li class="menuHover box-icon">
                        <a href="../admin/VerifyAccount.php" class="nav-link text-left" role="button">
                            ...
                            <span class="badge badge-success" style="font-size: 12px; margin-left: 50px;">
                    ...
                    <li class="menuHover">
                        <a href="../admin/cards.php" class="nav-link text-left" role="button">
                            <i class="flaticon-bar-chart-1"></i> <i class="bx bxs-credit-card ico"></i>Cards Requests
                            <span class="badge badge-success" style="font-size: 12px; margin-left: 50px;">
                                <?php echo $debitNotify; ?> new</span>
                        </a>
                    </li>
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li>
                                <a class="nav-link" href="#" role="button">
                                    ...
                                    <img id="AdminDropdown" class="img-profile rounded-circle"
                                        src="../user/customer_data/Profile_Img/administratorAdmin12.png">
                                </a>
                            </li>
                        ...
                        <div class="row">
                            <div class="col-md-12 mt-lg-4 mt-4">
                                ...
                                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                    ...
                                    <div>
                                        <a href="../admin/wallet/Deposit.php" role="button"
                                            class="btn btn-success btn-circle btn-md ShowHide mr-5">
                                            <div><i class='bx bxs-down-arrow-alt bx-sm'></i></div>Deposit
                                        </a>
                                        <a href="../admin/wallet/Withdraw.php" role="button"
                                            class="btn btn-danger btn-circle btn-md ShowHide mr-5">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="card gray_bg">
                                            <div class="card-body card-shadow">
                                                ...
                                                <h1 class="display-5 mt-1 mb-3 light"><?php echo "$TotalCustomer"; ?>
                                                </h1>
                                                <div class="mb-1">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="card gray_bg">
                                            <div class="card-body card-shadow">
                                                ...
                                                <h1 class="display-5 mt-1 mb-3 light"><?php echo $InactiveAccount; ?>
                                                </h1>
                                                <div class="mb-1">
                                                    <span class="text-danger"> <i
                                                            class="mdi mdi-arrow-bottom-right"></i></span>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="card gray_bg">
                                            <div class="card-body card-shadow">
                                                ...
                                                <h1 class="display-5 mt-1 mb-3 light"><?php echo $DeactiveAccount; ?>
                                                </h1>
                                                <div class="mb-1">
                                                        ...
                                                        <div class="card gray_bg">
                                                            <div class="card-body card-shadow">
                                                                ...
                                                                <div class="d-flex justify-content-center">
                                                                    <a role="button"
                                                                        href="../admin/accounts/EditAccount.php"
                                                                        class="btn text-decoration-none btn-custo mt-3 mb-3"><i
                                                                            class='bx bxs-pencil'></i> Edit Account</a>
                                                                </div>
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="card gray_bg">
                                                            <div class="card-body card-shadow">
                                                                ...
                                                                <div class="d-flex justify-content-center">
                                                                    <a role="button"
                                                                        href="../admin/accounts/ActivateAccount.php"
                                                                        class="btn text-decoration-none btn-custo mt-3 mb-3"><i
                                                                            class='bx bx-power-off'></i> Activate
                                                                        Account</a>
                                                                </div>
                    ...
                    <div class="container-fluid">
                        <div class="row text-muted">
                            <div class="col-6 text-left">
                                <p class="mb-0">
                                    <a href="../index.php" class="text-muted light"><strong>SSGC Bank
                                        </strong></a> &copy
                                </p>
                            </div>
    ...
    var myChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: '# of Votes',
                data: [<?php echo $ActiveAccount ?>, <?php echo $InactiveAccount ?>,
                    <?php echo $DeactiveAccount ?>
                ],
                backgroundColor: [
                    'rgba(76, 175, 80, 0.2)',
                    'rgba(102, 31, 255, 0.2)',
