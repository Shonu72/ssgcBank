...
$(document).ready(function () {
        ...
        $.ajax({
          ...
          success: function (response) {
            if (response["Flag"] != "fail") {
              ...
              popFlag = 0;
              $("#SenderAcError").text(
                "Account Number Not Found. Note: Refresh The Page for next account no"
              );
            }
          },
        });
  ...
  $("#ReceiverAc").on({
    click: function () {
      if (popFlag == 1) $("#SenderAc").popover("toggle");
      else $("#SenderAc").popover("hide");
    },
    ...
    keyup: function () {
      ...
      if (ReceiverAc.length == 12) {
        ...
        if (ReceiverAc == SenderAc) {
          $("#ReciverAcError").text(
            "You Cannot transfer money in same account"
          );
        } else {
