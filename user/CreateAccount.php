...
<head>
    ...
    <title>Create Account SSGC Bank</title>
...
<body>
    ...
    <form id="regForm" action="<?php htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST"
        ...
        <div class="tab mb-3">
                ...
                <div class="col-md">
                    <div class="col-md">
                        <div class="form-floating">
                            ...
                            <input type="text" name="FatherName" class="form-control" id="FAname"
                ...
                <div class="col-md">
                    <div class="col-md">
                        <div class="form-floating">
                            ...
                            <input type="text" name="MotherName" class="form-control" id="MAname"
            ...
            <div class="row g-2 mb-3">
                ...
                <div class="col-md">
                    <div class="col-md">
                        <div class="form-floating">
                            <input name="MobileNumber" class="form-control" type="tel" id="MobileNo" pattern="[0-9]{10}"
            ...
            <div class="row g-2 mb-3">
                <div class="col-md">
                    <div class="col-md">
                        <div class="form-floating">
                            <input type="text" name="PanNumber" class="form-control" id="PanNo"
                ...
                <div class="col-md">
                    <div class="col-md">
                        <div class="form-floating">
                            <input name="AdharNumber" class="form-control" type="tel" id="AdharNo" pattern="[0-9]{12}"
                                placeholder="Adhar Number" onkeypress="return isNumber(event)">
            ...
            <div class="row g-2 mb-3">
                ...
                <div class="col-md">
                    <div class="col-md">
                        <div class="form-floating">
                            <input name="pincode" class="form-control" type="tel" id="pincode" pattern="[0-9]{6}"
                                placeholder="Pin Code" onkeypress="return isNumber(event)">
        ...
        <div class="tab mb-3" id="KycTab">
            ...
            <div class="form-group mb-3">
                ...
                <input type="file" name="PanCardUp" class="form-control-file" id="PANCardUp" size="30"
            ...
            <div class="form-groupmb-3">
                ...
                <input type="file" name="AdharCardUp" class="form-control-file" id="AdharCardUp" size="30"
                    accept="image/jpg,image/png,image/jpeg,image/gif">
            ...
            <div class="col-md mb-3">
                <div class="col-md">
                    ...
                    <div class="form-floating OtpMobile">
                        <input type="tel" class="form-control" name="Otp" id="Otp" placeholder="Enter 6 Digit OTP"
                            pattern="[0-9]{6}">
                ...
                <div class="col-md">
                    <div class="form-floating">
                        <input class="form-control" type="password" name="Password" id="Password"
                            placeholder="Enter Password" data-toggle="tooltip" data-placement="top"
                            title="Enter Password with atleast 8 charater long with 1 Capital 1 small 1 number and 1 special charater">
